...
// open the following flag to calculate the relocation address by manual
#define FIX_ADDRESS_BY_MANUAL 0
...
#if FIX_ADDRESS_BY_MANUAL
    // adjust the add5 function and add10 function address by manual
